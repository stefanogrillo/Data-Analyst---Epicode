...
L'obiettivo preposto è di realizzare un modello, se possibile a livello regionale, che riguardi le differenze di stipendi e costi riguardanti gli ambiti _ristorazione_ e _IT_. <br>
...
Le differenze tra _reddito lordo_ e _reddito netto_ sono utili al committente per analizzare il cuneo fiscale nei due Paesi (e il Welfare Statale). <br>
Le differenze tra _stipendio netto_ e _costo della vita_, cioè ciò che rimane in mano al lavoratore a fine mese, è l'obiettivo commissionato, in quanto questa variabile potrebbe essere utile al commissionante per comprendere come incentivare l'attrazione di nuovi talenti in Italia. <br>
I dati per i Paesi Germania e Italia sono: reddito
